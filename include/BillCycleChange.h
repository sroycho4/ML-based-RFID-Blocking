/** @file BillCycleChange.h
* @brief BillCycleChange Component
*/

//////////////////////////////////////////////////////////////////////
// BillCycleChange.h: Interface for doing BillCycleChange
//
//////////////////////////////////////////////////////////////////////


#ifndef BILL_CYC_CHNG_H
#define BILL_CYC_CHNG_H
...
/*********************************************************************
#   File        :   BillCycleChange.h
#   Abstract    :   This component is used for doing BillCycleChange
#   Date        :   05th Feb,2014
#   Author(s)   :   Ralph
#   Code Size   :   
#   Design      :   
...
/** @class BillCycleChange
* @ingroup Components
* @brief Terminate Accounts
* @details 
*/

class EXPORT BillCycleChange : public CBaseComponent
{
...
protected:
	...
	*/
	...
	//Config params
	ABL_String          m_activeStatusCode;
	ABL_String          m_suspendedStatusCode;

public:
	/** Default BillCycleChange default constructor
	*/
	BillCycleChange();

	/** Default BillCycleChange default destructor
	*/
	virtual ~BillCycleChange();

	/** Default BillCycleChange copy constructor
	*/
	BillCycleChange(const BillCycleChange &p_BillCycleChange);

	/** Interface to clone the BillCycleChange object.
	*/
	virtual Base_Registry* mb_clone(){return (Base_Registry*) new BillCycleChange(*this);}
...
extern "C" {EXPORT Base_Registry* gb_getBillCycleChange();}

#endif //BILL_CYC_CHNG_H
